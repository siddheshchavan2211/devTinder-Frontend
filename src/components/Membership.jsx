...
const Membership = () => {
  ...
  return status ? (
    ...
    <div className="bg-red-300 h-screen">
      <div className="flex flex-col justify-center mx-auto py-20  items-center  ">
        <h1 className="lg:text-5xl text-3xl font-bold italic mb-4 text-white">
          Subscription Tiers
        </h1>
        <p className="lg:text-xl px-2  font-semibold lg:mb-4 text-white">
          Upgrade to Gold, or Platinum for an enhanced Tinder experience.
        </p>
      </div>
      <div className=" flex flex-col lg:flex-row gap-14 justify-center items-center mb-24  ">
        <div className="card border border-white bg-white w-96 h-80 shadow-xl pt-4 translate delay-150 easy-in-out duration-300 lg:hover:translae-y-1 lg:hover:scale-110 lg:hover:ease-in-out">
